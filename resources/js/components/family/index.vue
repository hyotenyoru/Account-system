    ...
    <div>
      <div><h2>您好!這裡是{{index['title']}}</h2></div>
       <div class="row justify-content-end">
        <div class="col-2">
          <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#familyModal">
              {{create['title']}}
          </button>
        </div>
        <div class="col-4">
    ...
    export default {
      ...
      data: function() {
              return {
                  ...
                  key:json['index']['key'],
                  custom_key:json['index']['custom_key'],
      ...
      computed:{
        list:function () {
          ...
          this.datas.forEach(array => {
            var arraykey=array[this.custom_key];
